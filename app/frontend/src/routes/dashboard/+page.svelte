	...
	<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		...
		{:else}
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<a href="/warehouse/reports/stock" class="card hover:shadow-md transition-shadow cursor-pointer bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
					<div class="flex items-center mb-2">
						<svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
						</svg>
						<h3 class="text-lg font-semibold text-gray-900">{$_('reports.warehouse.title')}</h3>
					</div>
					<p class="text-gray-600">Stock, pricing, transfers, and expiration reports</p>
				</a>
