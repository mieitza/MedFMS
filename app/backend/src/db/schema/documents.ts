...
export const documents = sqliteTable('documents', {
  ...
  entityType: text('entity_type', { enum: ['vehicle', 'driver', 'user', 'maintenance_work_order'] }).notNull(),
...
export const photos = sqliteTable('photos', {
  ...
  entityType: text('entity_type', { enum: ['vehicle', 'driver', 'user', 'incident', 'maintenance_work_order'] }).notNull(),
  entityId: integer('entity_id').notNull(),
  description: text('description'),
