...
"[project]/app/frontend-next/src/app/(dashboard)/maintenance/approvals/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MaintenanceApprovalsPage() {
    ...
    const [priorityFilter, setPriorityFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [selectedWorkOrder, setSelectedWorkOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [approvalNotes, setApprovalNotes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [showApprovalDialog, setShowApprovalDialog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showRejectDialog, setShowRejectDialog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [currentPage, setCurrentPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const pageSize = 20;
    // Fetch pending approvals
    const { data: approvalsData, isLoading, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'maintenance',
            'pending-approval',
            priorityFilter,
        ...
        queryFn: {
            "MaintenanceApprovalsPage.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$src$2f$lib$2f$api$2f$maintenance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maintenanceApi"].getPendingApproval({
                    page: currentPage,
                    pageSize,
                    ...priorityFilter !== 'all' ? {
        ...
        }["MaintenanceApprovalsPage.useQuery"]
    });
    const workOrders = approvalsData?.data || [];
    // Filter by search term
    const filteredWorkOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MaintenanceApprovalsPage.useMemo[filteredWorkOrders]": ()=>{
            if (!searchTerm) return workOrders;
            const term = searchTerm.toLowerCase();
            return workOrders.filter({
                "MaintenanceApprovalsPage.useMemo[filteredWorkOrders]": (wo)=>wo.workOrderNumber?.toLowerCase().includes(term) || wo.vehicle?.vehicleCode?.toLowerCase().includes(term) || wo.vehicle?.licensePlate?.toLowerCase().includes(term) || wo.title?.toLowerCase().includes(term)
            }["MaintenanceApprovalsPage.useMemo[filteredWorkOrders]"]);
        }
    }["MaintenanceApprovalsPage.useMemo[filteredWorkOrders]"], [
        workOrders,
    ...
    // Approve mutation
    const approveMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "MaintenanceApprovalsPage.useMutation[approveMutation]": ({ id, notes })=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$src$2f$lib$2f$api$2f$maintenance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maintenanceApi"].approve(id, notes)
        }["MaintenanceApprovalsPage.useMutation[approveMutation]"],
        onSuccess: {
            "MaintenanceApprovalsPage.useMutation[approveMutation]": ()=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Comandă de lucru aprobată cu succes');
        ...
        onError: {
            "MaintenanceApprovalsPage.useMutation[approveMutation]": (error)=>{
    ...
    // Reject mutation
    const rejectMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "MaintenanceApprovalsPage.useMutation[rejectMutation]": ({ id, notes })=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$src$2f$lib$2f$api$2f$maintenance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maintenanceApi"].reject(id, notes)
        }["MaintenanceApprovalsPage.useMutation[rejectMutation]"],
        onSuccess: {
            "MaintenanceApprovalsPage.useMutation[rejectMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Comandă de lucru respinsă');
        ...
        onError: {
            "MaintenanceApprovalsPage.useMutation[rejectMutation]": (error)=>{
    ...
    const confirmReject = ()=>{
        if (!approvalNotes.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Motivul respingerii este obligatoriu');
            return;
        }
        if (selectedWorkOrder) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 360,
                            columnNumber: 13
                        }, this) : filteredWorkOrders.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    ...
                    children: [
                        ...
                        selectedWorkOrder && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-4",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MaintenanceApprovalsPage, "p+D0kLaj9woQpnsWz2wd94ilewY=", false, function() {
    return [
...
_c = MaintenanceApprovalsPage;
var _c;
__turbopack_context__.k.register(_c, "MaintenanceApprovalsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_frontend-next_src_d0a08e15._.js.map